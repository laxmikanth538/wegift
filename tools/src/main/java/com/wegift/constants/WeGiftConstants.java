package com.wegift.constants;

public class WeGiftConstants {
	/**
	...
	public static String WEGIFT_CONTEXT_ROOT = "/wegift-admin-web";

	public static final String ACTIVATION_CODE = "WGACT";
	public static final String STATUS_PENDING = "P";
	public static final String STATUS_ACTIVE = "A";
	public static final String STATUS_DEACTIVATED = "DA";

	public static final int ADMIN_ROLE = 1;
	public static final int MERCHANT_ROLE = 2;
